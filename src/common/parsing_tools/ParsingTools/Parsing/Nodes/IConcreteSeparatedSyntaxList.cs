...
/// <summary>
/// 	Represents a concrete syntax list that has separator nodes.
/// </summary>
...
/// </summary>
/// <typeparam name="TValue">The type of the value nodes.</typeparam>
public class ConcreteSeparatedSyntaxList<TValue> : ConcreteSeparatedSyntaxList<TValue, IConcreteSyntaxToken>
	where TValue : class, IConcreteSyntaxNode
{
	#region Constructors
	...
	/// <param name="values">The value nodes in the list.</param>
	/// <param name="separators">The separator nodes in the list.</param>
	public ConcreteSeparatedSyntaxList(
		IReadOnlyList<IConcreteSyntaxNode> nodes,
		IReadOnlyList<TValue> values,
		IReadOnlyList<IConcreteSyntaxToken> separators)
