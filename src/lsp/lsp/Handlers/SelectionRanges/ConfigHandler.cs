...
{
	#region Nested types
	private sealed class ConfigHandler : BaseCustomTreeHandler<SelectionRangeParams, SelectionRangeResponse, IConfigSyntaxTree>
	{
		#region Methods
		protected override SelectionRangeResponse? Handle(HandlerRequest<SelectionRangeParams> request, IConfigSyntaxTree tree, CancellationToken cancellation)
		{
